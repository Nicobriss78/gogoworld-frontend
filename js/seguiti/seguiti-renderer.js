import { createSeguitiBannerSlot } from "./seguiti-banners.js";
...
export function renderSections(refs, sections) {
...
export function setRailMode(sectionEl, mode) {
...
export function scrollToFirstActiveEventCard(rail) {
  if (!rail) return;
...
export function syncRailScrollbar(sectionEl) {
...
export function bindRailScrollbars(sectionEl) {
